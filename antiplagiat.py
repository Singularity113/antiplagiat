...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.openAction = QAction("Выбрать", self)
    ...
    def slot_btn(self): # Функция для проверки
        ...
        self.source_1 = self.text1 # text1 нужно заменить на текст после канонизации!
        self.source_2 = self.text2 # text2 нужно заменить на текст после канонизации!
